...
class Role(models.Model):
    ...
    name = models.CharField(max_length=255, choices=ROLE_CHOICE)
...
class UserManager(BaseUserManager):
    ...
    def create_superuser(self, email, first_name, last_name, role, date_of_birth, password=None):
        """
...
class User(AbstractBaseUser):
    ...
    role = models.ForeignKey(Role, on_delete=models.CASCADE, default='Unassigned', blank=True)
