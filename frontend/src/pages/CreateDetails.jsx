...
const CreateDetails = ({email}) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    console.log(semester,department, hall, user_id, bloodGroup, session)
    if (!user_id || !semester || !department || !hall || !SID || !hsc_reg || !bloodGroup || !phone || !session) {
